"""
Django settings for PeminjamanRuanganSarpras project.
...
ROOT_URLCONF = 'PeminjamanRuanganSarpras.urls'
...
WSGI_APPLICATION = 'PeminjamanRuanganSarpras.wsgi.application'
